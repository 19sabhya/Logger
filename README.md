...
**Level**: Level is used to specify level till which the entry has to be made in the log file. It accepts an integer value, such that counter begins at 0 from the point it is called.
